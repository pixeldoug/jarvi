...
| `TWILIO_ONBOARDING_WELCOME_CONTENT_SID` | Content SID do template de boas-vindas enviado ao concluir o wizard | `HX...` |
| `TWILIO_ONBOARDING_INTRO_CONTENT_SID` | Content SID do template de intro no fim da jornada das primeiras tarefas (fotos/áudios/docs + dica de fixar a conversa). Variável `1` = nome | `HX...` |
| `TWILIO_ONBOARDING_TASKS_CONFIRMATION_CONTENT_SID` | Content SID do template de confirmação das tarefas no fim da jornada. Variável `1` = linha das tarefas | `HX...` |
