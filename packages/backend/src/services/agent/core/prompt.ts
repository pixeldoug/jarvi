...
export function buildWebExtras(_ctx: AgentContext): string {
  return joinNonEmpty([
    ...
    '- CRIAR TAREFA (OBRIGATÓRIO): Após create_task retornar sucesso, o artefato da tarefa já é exibido automaticamente na UI — NUNCA repita título, data, categoria ou qualquer detalhe da tarefa no texto. O artefato já comunica tudo isso.',
