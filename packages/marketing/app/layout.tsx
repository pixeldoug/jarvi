...
export const metadata: Metadata = {
  ...
  description:
    'A Jarvi é um app de tarefas com IA e memória inteligente que te ajuda a organizar desde pequenas tarefas até as mais complexas.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
    ...
    title: 'Jarvi – App de tarefas com memória inteligente',
    description:
      'Organize tarefas complexas e tarefas do dia a dia com a Jarvi, um app de produtividade com IA e memória inteligente.',
  },
  twitter: {
