...
| `ARCHITECTURE.md`, `*_RUNBOOK.md`, `STRIPE_SETUP.md`, `PRODUCTION_PLAN.md`, `SETUP_NOVO_COMPUTADOR.md`, `WHATSAPP_TASKS.md`, `bug-bash-criar-conta.md` | Ops / engenharia **já existentes** — ficam na raiz de `docs/` neste passo | Como subir WhatsApp em produção; checklist de QA | Contrato de UI |
